...
const createDayInfoTemplate = (dayNumber, date, hideDates) => {
  let info = `<span class="day__counter">${dayNumber}</span>
    <time class="day__date" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["setDateToHTMLFormat"])(date)}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["setDateToMonthDDFormat"])(date)}</time>`;
  if (hideDates) {
    info = ``;
  }
  return info;
...
class Days extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createFilterMarkup = (name, isChecked, count) => {
...
const createFilterTemplate = (filters) => {
  const filtersMarkup = filters.map((it) => createFilterMarkup(it.name, it.checked, it.count)).join(`\n`);
...
class Menu extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setActiveItem(item) {
    this.getElement().querySelectorAll(`${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuElement"].ALL}`).forEach((it) => {
      if (it.classList.contains(`${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuElement"].ACTIVE}`)) {
        it.classList.remove(`${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuElement"].ACTIVE}`);
      }
    });

    this.getElement().querySelector(`#${item}`).classList.add(`${_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuElement"].ACTIVE}`);
  }
...
class NewPoint extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/no-route-points.js":
/*!*******************************************!*\
  !*** ./src/components/no-route-points.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoRoutePoints; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class NoRoutePoints extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RouteCost; });
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/components/abstract-component.js");
...
class RouteCost extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RouteInfo; });
...
const generateTripTitles = (routePoints) => {
  const tripTitles = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["uniqueItems"])(routePoints.map((routePoint) => {
...
const generateTripDates = (routePoints) => {
  ...
  const tripDates = routePoints
    ...
    .map((date) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["setDateToMonthDDFormat"])(date.eventStartDate));
...
class RouteInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  getTemplate() {
...
/***/ "./src/components/route-point-edit.js":
/*!********************************************!*\
  !*** ./src/components/route-point-edit.js ***!
  \********************************************/
/*! exports provided: default */
...
const generateEventTypesListTemplate = (events) => {
  const groups = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["uniqueItems"])(events.map((it) => it.type));
...
const createRoutePointTemplate = (routePoint, eventTypes) => {
  ...
  const {duration} = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDatesDuration"])(eventStartDate, eventEndDate);
    ...
    `<li class="trip-events__item">
      <div class="event">
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["setDateToHTMLFormat"])(eventStartDate)}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["setDateToHHMMFormat"])(eventStartDate)}</time>
            &mdash;
            <time class="event__end-time" datetime="${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["setDateToHTMLFormat"])(eventEndDate)}">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["setDateToHHMMFormat"])(eventEndDate)}</time>
          </p>
  ...
  return (
    `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      <div class="trip-sort__item  trip-sort__item--event">
        <input id="sort-${SortType.EVENT}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-event" checked>
...
const renderMoneyChart = (moneyCtx, routePointsList, moneyList) => {
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(moneyCtx, {
...
const renderTransportChart = (transportCtx, routePointsList, transportList) => {
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(transportCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3___default.a],
    type: `horizontalBar`,
    data: {
      labels: routePointsList,
...
const renderTimeSpendChart = (timeSpendCtx, routePointsList, timeSpendList) => {
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(timeSpendCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3___default.a],
    type: `horizontalBar`,
    data: {
      labels: routePointsList,
    ...
    options: {
      plugins: {
        datalabels: {
          ...
          align: `start`,
          formatter: (val) => {
            const days = moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(val).days();
            const hours = moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(val).hours();
            const minutes = moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(val).minutes();

            return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["generateTextDuration"])(days, hours, minutes);
          }
        }
      },
      title: {
...
class Statistic extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super();
...
class Trip extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: FilterType, MenuElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class FilterController {
  constructor(container, routePointsModel) {
    ...
    this._activeFilterType = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING;
  ...
  render() {
    ...
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["getRoutePointsByFilter"])(allRoutePoints, filterType).length,
...
class PointController {
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldRoutePointComponent && oldRoutePointEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._routePointComponent, oldRoutePointComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._routePointEditComponent, oldRoutePointEditComponent);
          document.removeEventListener(`keydown`, this._onEscKeyDown);
          ...
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._routePointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.ADDING:
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._routePointEditComponent);
  ...
  _colseRoutePointEditForm() {
    ...
    if (document.contains(this._routePointEditComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._routePointComponent, this._routePointEditComponent);
    }
    this._mode = Mode.DEFAULT;
  ...
  _openRoutePointEditForm() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._routePointEditComponent, this._routePointComponent);
    this._onViewChange();
...
/* harmony import */ var _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/sorting.js */ "./src/components/sorting.js");
/* harmony import */ var _components_no_route_points_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/no-route-points.js */ "./src/components/no-route-points.js");
/* harmony import */ var _components_days_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/days.js */ "./src/components/days.js");
/* harmony import */ var _components_day_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/day.js */ "./src/components/day.js");
...
/* harmony import */ var _point_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./point.js */ "./src/controllers/point.js");
...
const getSortedRoutePoints = (routePoints, sortType) => {
  ...
  switch (sortType) {
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT:
      sortedRoutePoints = showingRoutePoints.sort((a, b) => parseInt(a.eventStartDate, 10) - parseInt(b.eventStartDate, 10));
      break;
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].TIME:
      ...
      break;
    case _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].PRICE:
...
class TripController {
  constructor(container, routePointsModel, routeCoast, routeInfo, filterController, routeStat, offersList, destinationsList, api) {
    ...
    this._daysComponent = new _components_days_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  ...
  render() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(tripSorting, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTEREND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(tripEvents, this._daysComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);

    this._renderRoutePoints(this._routePointsModel.getRoutePoints(), _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT);
  }
  ...
  _renderRoutePointsWithDays(daysComponent, routePoints, sortType, onDataChange, onViewChange) {
    ...
    let dayNumber = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["getDatesDuration"])(firstEventStartDate, routePoints[0].eventStartDate).daysBetween;
    let dayComponent = new _components_day_js__WEBPACK_IMPORTED_MODULE_3__["default"](dayNumber + 1, routePoints[0].eventStartDate, sortType !== _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT);
    ...
    return routePoints.map((routePoint) => {
      if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["getDatesDuration"])(firstEventStartDate, routePoint.eventStartDate).daysBetween > dayNumber && sortType === _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT) {
        dayNumber = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_5__["getDatesDuration"])(firstEventStartDate, routePoint.eventStartDate).daysBetween;
        dayComponent = new _components_day_js__WEBPACK_IMPORTED_MODULE_3__["default"](dayNumber + 1, routePoint.eventStartDate);
        this._days.push(dayComponent);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(daysComponent.getElement(), dayComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
      }
  ...
  _renderRoutePoints(routePoints, sortType) {
    if (this._noRoutePoints) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._noRoutePoints);
    }

    if (routePoints.length <= 0) {
      this._noRoutePoints = new _components_no_route_points_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._daysComponent.getElement(), this._noRoutePoints, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
      return;
    }
  ...
  setSortDefault() {
    ...
    this._onSortTypeChange(_components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT);
  }
  ...
  _removeRoutePoints() {
    ...
    this._showedRoutePointControllers = [];
    this._days.forEach((day) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(day));
    this._days = [];
  }

  _updateRoutePoints(sortType = _components_sorting_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].EVENT) {
  ...
  _onDataChange(routePointController, oldData, newData, updateData = true) {
    if (oldData === _point_js__WEBPACK_IMPORTED_MODULE_6__["default"].getEmptyRoutePoint(this._offersList, this._destinationsList)) {
      ...
      if (newData === null) {
        ...
        routePointController.render(newData, _point_js__WEBPACK_IMPORTED_MODULE_6__["Mode"].DEFAULT);
...
class Points {
  ...
  getRoutePoints() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getRoutePointsByFilter"])(this._routePoints, this._activeFilterType);
  }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setDateToHTMLFormat", function() { return setDateToHTMLFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setDateToHHMMFormat", function() { return setDateToHHMMFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setDateToMonthDDFormat", function() { return setDateToMonthDDFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateTextDuration", function() { return generateTextDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDatesDuration", function() { return getDatesDuration; });
...
const pretextFromEventType = (eventType) => {
...
const getRandomNumbers = function (minNumber, maxNumber, count) {
  let array = [];
  let number;
...
const setDateToHTMLFormat = (dateInInt) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dateInInt).format(`YYYY-MM-DDTHH:mm`);
};

const setDateToHHMMFormat = (dateInInt) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dateInInt).format(`HH:mm`);
};

const setDateToMonthDDFormat = (dateInInt) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(dateInInt).format(`MMM DD`);
};

const generateTextDuration = (days, hours, minutes) => {
  return `${days > 0 ? `${setZeroAtStart(days)}D` : ``} ${hours > 0 ? `${setZeroAtStart(hours)}H` : ``} ${minutes > 0 ? `${setZeroAtStart(minutes)}M` : ``}`;
};

const getDatesDuration = (date1InInt, date2InInt) => {
  const startDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(date1InInt);
  const endDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(date2InInt);

  const days = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(endDate.diff(startDate)).days();
  const hours = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(endDate.diff(startDate)).hours();
  const minutes = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(endDate.diff(startDate)).minutes();
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getEverythingRoutePoints, getFutureRoutePoints, getPastRoutePoints, getRoutePointsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEverythingRoutePoints", function() { return getEverythingRoutePoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFutureRoutePoints", function() { return getFutureRoutePoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPastRoutePoints", function() { return getPastRoutePoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRoutePointsByFilter", function() { return getRoutePointsByFilter; });
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common.js */ "./src/utils/common.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");



const getEverythingRoutePoints = (routePoints) => {
  return routePoints;
};

const getFutureRoutePoints = (routePoints) => {
  return routePoints.filter((routePoint) => Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["isFutureEvent"])(routePoint.eventStartDate));
};

const getPastRoutePoints = (routePoints) => {
  return routePoints.filter((routePoint) => Object(_common_js__WEBPACK_IMPORTED_MODULE_0__["isPastEvent"])(routePoint.eventEndDate));
};

const getRoutePointsByFilter = (routePoints, filterType) => {
  switch (filterType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].EVERYTHING:
      return getEverythingRoutePoints(routePoints);
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].FUTURE:
      return getFutureRoutePoints(routePoints);
    case _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].PAST:
